...
PYTHON_SITE_PACKAGE_FOLDER=$(python3 -c "import sysconfig; print(sysconfig.get_path('purelib'))")  # Get the python site-packages folder where Jovian is installed
...
typingtool() {
    ...
    local srcdir="${PYTHON_SITE_PACKAGE_FOLDER}/Jovian/workflow/"
